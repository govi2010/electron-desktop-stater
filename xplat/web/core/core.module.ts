...
export class ElectronStaterCoreModule {
  constructor(
    @Optional()
    @SkipSelf()
    parentModule: ElectronStaterCoreModule
  ) {
    throwIfAlreadyLoaded(parentModule, 'ElectronStaterCoreModule');
  }
}
